...
#n4_heatmap_matrix = reshape(n4_aic_df.norm_aic, 4,3)' # first reshape, then transpose

#row_labs = ["Aurnhammer et al. (2021)",
#            "Delogu et al. (2019)",
#            "Aurnhammer et al. (2023)"]
#col_labs = ["Condition", "Leo-13b", "GerPT-2 large", "GerPT-2"]
#p = heatmap(col_labs,row_labs,n4_heatmap_matrix, c=:blues)
# Add annotations (values) to the heatmap cells
#for i in 1:size(n4_heatmap_matrix, 1)
#    for j in 1:size(n4_heatmap_matrix, 2)
#        annotate!(j, i, text(string(Int(round(n4_heatmap_matrix[i, j], digits=0))), :black, 8, halign=:center, valign=:center))
#    end
#end
